    ...
    <div style={styles.shell}>
      <div style={styles.phone}>
        ...
        <div style={styles.screen}>
          {screen === "home" && <HomeScreen specials={specials} openCategory={openCategory} search={search} setSearch={setSearch} vegFilter={vegFilter} setVegFilter={setVegFilter} menuItems={menuItems} openItem={openItem} />}
        ...
        {screen !== "detail" && (
          <div style={styles.bottomNav}>
            {[
              ...
              return (
                <button key={tab.id} style={{...styles.navTab, ...(active ? styles.navTabActive : {})}}
                  onClick={() => tab.id === "home" ? goHome() : openCategory(tab.id)}>
...
function HomeScreen({ specials, openCategory, search, setSearch, vegFilter, setVegFilter, menuItems, openItem }) {
...
const styles = {
  ...
  filterBtnActive: {
    background:"#e07b39", borderColor:"#e07b39", color:"#fff",
  },
